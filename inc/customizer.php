		...
		class WP_Customize_Layout_Control extends WP_Customize_Control {
			...
			<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
				...
				<li class="customizer-control-row">
					<input type="radio" value="<?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $this->id ); ?>" <?php echo esc_attr( $this->link() ); ?> <?php
					if ( $this->value() === $key ) {
